...
-- DISTINCT is no needed in this case, but would cover if someone saw show twice - would be counted once
SELECT COUNT (DISTINCT shows_users.user_id) FROM shows_users 
