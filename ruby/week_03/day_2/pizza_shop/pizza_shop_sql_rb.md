...
SQL injections happen when a method accepts any form of input from the user without sanitizing said input. To protect agains such attacks, we can use something called a prepared statement.
