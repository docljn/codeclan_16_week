...
visit3.save()
visit4 = Visit.new({ 'user_id' => user2.id, 'location_id' => location2.id, 'review' => '3 stars, could not find my wizard friend in the crowd'})
visit5 = Visit.new({ 'user_id' => user2.id, 'location_id' => location2.id, 'review' => '3 stars, could not find my wizard friend in the crowd'})
visit4.save()
visit5.save()

visit6 = Visit.new({'user_id' => user2.id, 'location_id' => location1.id,  'review' => 'Had fun, be glad that we left tho. 3 Stars'})
visit6.save()
